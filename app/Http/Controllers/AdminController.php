...
class AdminController extends Controller
{
    ...
    public function warehouseDetail(Warehouse $warehouse){
        ...
        return view('admin.warehouse.detail',compact('warehouse','farmCrops'));
    }

    public function addCropToWarehouse($id){
        $crops = Crop::all();
        return view('admin.warehouse.create-crop',compact('crops','id'));
    }
    public function warehouseStoreFarmCrop(Request $request)
    {
        ...
        return redirect()->route('admin.view.warehouse.detail', request('warehouse'))
            ->with('success','Farm crop added successfully!');
    }
    public function warehouseCropDetail($id){
        $detail = WarehouseCrop::where('id',$id)->first();
        return view('admin.warehouse.view_crop_details',compact('detail'));
    }
