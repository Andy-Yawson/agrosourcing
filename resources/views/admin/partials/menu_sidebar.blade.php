    ...
    <li class="nav-item">
        ...
        <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                <a class="collapse-item" href="{{ route('admin.add.farm.crop') }}">Add Crop</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseFunding" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                <a class="collapse-item" href="{{ route('admin.add.product') }}">Add Processing Site</a>
                <a class="collapse-item" href="{{ route('admin.view.product') }}">View Processing Site</a>
                <a class="collapse-item" href="{{ route('admin.add.processing.product') }}">Add Product</a>
            </div>
        </div>
    </li>
    <li class="nav-item">
        ...
        <div id="collapseUsers" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
            <div class="bg-white py-2 collapse-inner rounded">
                ...
                @if(auth()->user()->level == 1)
                    <a class="collapse-item" href="{{ route('admin.view.data-users') }}">Management Accounts</a>
