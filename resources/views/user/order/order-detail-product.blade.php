...
@section('content')
    ...
    <div class="shadow mb-4 p-4">
        <h3 class="font-weight-light p-3">Processed Product Details</h3>
        <div class="row">
            ...
            <div class="col-md-6 col-lg-6 col-sm-12 col-xs-12">
                ...
                <h3 class="font-weight-light mb-3">{{ $product->product->name }} Company</h3>
                ...
                <h4 class="font-weight-light mb-3">Location: {{ $product->product->region->name }}</h4>
