...
@section('content')
    ...
    <div class="shadow mb-4 p-4">
        ...
        @if(count($crops) > 0 or count($warehouses) > 0 or count($products) > 0)
            <div class="row">
                @foreach($crops as $crop)
                    <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 mb-3">
                        <div class="card shadow-sm">
                            <img class="card-img-top" src="{{ asset('img/farms/'.$crop->image) }}" alt="crop image" height="200px">
                            <div class="card-body">
                ...
                @foreach($products as $product)
                        <div class="col-md-3 col-lg-3 col-sm-6 col-xs-12 mb-3">
                            <div class="card shadow-sm">
                                ...
                                <div class="card-body">
                                    <h5 class="card-title"><i class="fa fa-dot-circle text-info"></i> Processing Site</h5>
