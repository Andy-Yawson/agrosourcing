            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs 12">
                        <img src="<?php echo e(asset('img/user_flow.svg')); ?>" alt="help icon" class="img-fluid" />
                    </div>
        ...
        <section class="py-5 mt-5 mb-5">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs 12">
                        <img src="<?php echo e(asset('img/mission.svg')); ?>" alt="help icon" class="img-fluid" style="transform: scaleX(-1);-webkit-transform: scaleX(-1);"/>
                    </div>
                </div>
            </div>
        </section>
...
<?php echo $__env->make('website.website-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/agrosourcing/resources/views/website/research.blade.php ENDPATH**/ ?>