<section class="py-5 mt-5" id="what-we-do" style="background-color: #f1f1f1">
    <div class="container">
        <h2 class="font-weight-light text-heading">What We Offer</h2>
        <p class="mb-5 lead">The categories we provide</p>

        <div class="row">
            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <div class="shadow-sm mb-5 bg-white p-4">
                    <h4 class="card-title text-uppercase font-weight-normal p-2 text-heading">CONNECTIVITY</h4>
            ...
            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <div class="shadow-sm mb-5 bg-white p-4">
                    <h4 class="card-title text-uppercase font-weight-normal p-2 text-heading">GREENCOAL</h4>
                    <p class="card-text lead">
            ...
            <div class="col-md-4 col-lg-4 col-sm-12 col-xs-12">
                <div class="shadow-sm mb-5 bg-white p-4">
                    <h4 class="card-title text-uppercase font-weight-normal p-2 text-heading">POTASSIUM CARBONATE SALT</h4>
                    <p class="card-text lead">
...
<?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/agrosourcing/resources/views/website/partials/what_we_offer.blade.php ENDPATH**/ ?>