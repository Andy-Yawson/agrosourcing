<?php $__env->startSection('web-content'); ?>
    <header>
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active" style="background-image: url('<?php echo e(asset('web/img/slider1.jpg')); ?>')">
                ...
                <div class="carousel-item" style="background-image: url('<?php echo e(asset('web/img/slider2.jpg')); ?>')">
                    <div class="carousel-caption d-none d-md-block">
                ...
                <div class="carousel-item" style="background-image: url('<?php echo e(asset('web/img/slider3.jpg')); ?>')">
                    <div class="carousel-caption d-none d-md-block">
    ...
    <main class="pt-5">
            ...
            <div class="container">
                ...
                <div class="row mt-4">
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-2">
                        <div class="shadow">
                            <div class="card-body text-center">
                                <img src="<?php echo e(asset('web/img/location.svg')); ?>" alt="agric" height="100px" width="70px"/>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-2">
                        <div class="shadow">
                            <div class="card-body text-center">
                                <img src="<?php echo e(asset('web/img/order.svg')); ?>" alt="agric" height="100px" width="70px"/>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-2">
                        <div class="shadow">
                            <div class="card-body text-center">
                                <img src="<?php echo e(asset('web/img/tractor.svg')); ?>" alt="agric" height="100px" width="70px"/>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12 mb-2">
                        <div class="shadow">
                            <div class="card-body text-center">
                                <img src="<?php echo e(asset('web/img/delivery.svg')); ?>" alt="agric" height="100px" width="70px"/>
        ...
        <?php echo $__env->make('website.partials.banner', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        <!-- About Us-->
            ...
            <div class="container">
                ...
                <div class="row mt-4">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <?php echo $__env->make('website.partials.slider', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
        ...
        <!-- Categories -->
       <?php echo $__env->make('website.partials.what_we_offer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>

        <?php echo $__env->make('website.partials.partners', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                ...
                <div class="row mt-4">
                    <div class="col-xl-4 col-md-4 col-lg-4 mb-4">
                        <div class="card border-0 shadow">
                            <img src="<?php echo e(asset('web/img/team1.jpg')); ?>"
                                 class="card-img-top">
                            <div class="card-body text-center">
                    ...
                    <div class="col-xl-4 col-md-4 col-lg-4 mb-4">
                        <div class="card border-0 shadow">
                            <img src="<?php echo e(asset('web/img/team3.jpeg')); ?>"
                                 class="card-img-top">
                            <div class="card-body text-center">
...
<?php echo $__env->make('website.website-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/agrosourcing/resources/views/website/welcome.blade.php ENDPATH**/ ?>