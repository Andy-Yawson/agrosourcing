<?php $__env->startSection('web-content'); ?>
    <main class="pt-5">
        ...
        <section class="py-5 mt-5" id="what-we-do" style="background-color: #f1f1f1">
            <div class="container">
                <h2 class="font-weight-light text-heading"><img src="<?php echo e(asset('img/help.svg')); ?>" alt="help icon" height="40px"/> Our Services</h2>
...
<?php echo $__env->make('website.website-master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/agrosourcing/resources/views/website/sourcemap.blade.php ENDPATH**/ ?>