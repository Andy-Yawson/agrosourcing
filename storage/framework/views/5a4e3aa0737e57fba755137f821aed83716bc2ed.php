...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card shadow mb-4 p-5">
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.store.farm')); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <div class="row">
                    <div class="col-6">
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/agrosourcing/resources/views/admin/farm/create.blade.php ENDPATH**/ ?>