...
<?php $__env->startSection('content'); ?>
    ...
    <div class="card shadow mb-4 p-5">
        <h5 class="font-weight-lighter">PROVIDE CROP DETAILS</h5>
        ...
        <div class="card-body">
            <form action="<?php echo e(route('admin.warehouse.addCrop.store',['warehouse'=>$id])); ?>" method="post" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Applications/XAMPP/xamppfiles/htdocs/agrosourcing/resources/views/admin/warehouse/create-crop.blade.php ENDPATH**/ ?>